      ...
      <div className={"hero-inner"}>
        ...
        <div className={"prompt-card"}>
          <div className={"prompt-input"}>
            <textarea className={"prompt-textarea"} placeholder={"Describe your spreadsheet\u2026 e.g. monthly budget template with categories, totals, and a savings tracker."} rows={2}></textarea>
          </div>
        ...
        <div className={"example-prompts"}>
          <span>{"Try:"}</span>
          <button className={"chip"}>{"Monthly budget template"}</button>
          <button className={"chip"}>{"Project tracking sheet"}</button>
          <button className={"chip"}>{"Quarterly sales report"}</button>
        </div>
      </div>
    </section>
