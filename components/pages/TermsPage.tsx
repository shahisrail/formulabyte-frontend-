    ...
    <>
      ...
      <section className="hero">
        <div className="hero-inner">
          ...
          <h1>
            {"Terms & "}
            <span className="accent">Conditions</span>
          </h1>
          <p className="lede">
            {"Please read these terms carefully before using Formula Byte services. By accessing our platform, you agree to be bound by these terms."}
          </p>
        </div>
      </section>
        ...
        <section className="card">
          <div className="row-stacked">
            <div className="row-header">
              ...
              <h2>
                {"Terms & "}
                <span className="serif-accent">Conditions</span>
              </h2>
              <p className="intro">Please read these terms carefully before using Formula Byte services. By accessing our platform, you agree to be bound by these terms.</p>
            ...
            <div className="row-body">
              <div className="faq-list">
                <details className="faq-item" open>
                  <summary className="faq-q">1. AGREEMENT TO TERM</summary>
                  <div className="faq-a">
                    <p>These Terms of Use constitute a legally binding agreement made between you, whether personally or on behalf of an entity ("you") and Data Set Match ("Company," "we," "us," or "our"), concerning your access to and use of the https://www.formulabyte.com website as well as any other media form, media channel, mobile website or mobile application related, linked, or otherwise connected thereto (collectively, the "Site"). We are registered in the United Kingdom. You agree that by accessing the Site, you have read, understood, and agreed to be bound by all of these Terms of Use. IF YOU DO NOT AGREE WITH ALL OF THESE TERMS OF USE, THEN YOU ARE EXPRESSLY PROHIBITED FROM USING THE SITE AND YOU MUST DISCONTINUE USE IMMEDIATELY.</p>
                ...
                <details className="faq-item">
                  <summary className="faq-q">2. INTELLECTUAL PROPERTY RIGHTS</summary>
                  <div className="faq-a">
                ...
                <details className="faq-item">
                  <summary className="faq-q">3. USER REPRESENTATIONS</summary>
                  <div className="faq-a">
                ...
                <details className="faq-item">
                  <summary className="faq-q">4. USER REGISTRATION</summary>
                  <div className="faq-a">
                ...
                <details className="faq-item">
                  <summary className="faq-q">5. PROHIBITED ACTIVITIES</summary>
                  <div className="faq-a">
                ...
                <details className="faq-item">
                  <summary className="faq-q">6. USER GENERATED CONTRIBUTIONS</summary>
                  <div className="faq-a">
                ...
                <details className="faq-item">
                  <summary className="faq-q">7. CONTRIBUTION LICENSE</summary>
                  <div className="faq-a">
                ...
                <details className="faq-item">
                  <summary className="faq-q">8. SUBMISSIONS</summary>
                  <div className="faq-a">
                ...
                <details className="faq-item">
                  <summary className="faq-q">9. SITE MANAGEMENT</summary>
                  <div className="faq-a">
                ...
                <details className="faq-item">
                  <summary className="faq-q">12. MODIFICATIONS AND INTERRUPTIONS</summary>
                  <div className="faq-a">
                    <p>We reserve the right to change, modify, or remove the contents of the Site at any time or for any reason at our sole discretion without notice. However, we have no obligation to update any information on our Site. We also reserve the right to modify or discontinue all or part of the Site without notice at any time. We will not be liable to you or any third party for any modification, price change, suspension, or discontinuance of the Site. For any lifetime deals we can discontinue all or part of the site without any notice at any time.</p>
                ...
                <details className="faq-item">
                  <summary className="faq-q">13. GOVERNING LAW</summary>
                  <div className="faq-a">
                ...
                <details className="faq-item">
                  <summary className="faq-q">14. DISPUTE RESOLUTION</summary>
                  <div className="faq-a">
                    ...
                    <p><strong>Binding Arbitration</strong> - If the Parties are unable to resolve a Dispute through informal negotiations, the Dispute (except those Disputes expressly excluded below) will be finally and exclusively resolved through binding arbitration. YOU UNDERSTAND THAT WITHOUT THIS PROVISION, YOU WOULD HAVE THE RIGHT TO SUE IN COURT AND HAVE A JURY TRIAL. The arbitration shall be commenced and conducted under the Commercial Arbitration Rules of the United Kingdom. Your arbitration fees and your share of arbitrator compensation shall be governed by the Consumer Rules and, where appropriate, limited by the Consumer Rules. The arbitration may be conducted in person, through the submission of documents, by phone, or online. The arbitrator will make a decision in writing, but need not provide a statement of reasons unless requested by either Party. The arbitrator must follow applicable law, and any award may be challenged if the arbitrator fails to do so. Except where otherwise required by the applicable rules or applicable law, the arbitration will take place in the United Kingdom. Except as otherwise provided herein, the Parties may litigate in court to compel arbitration, stay proceedings pending arbitration, or to confirm, modify, vacate, or enter judgment on the award entered by the arbitrator.</p>

                    <p><strong>Restrictions</strong> - The Parties agree that any arbitration shall be limited to the Dispute between the Parties individually. To the full extent permitted by law, (a) no arbitration shall be joined with any other proceeding; (b) there is no right or authority for any Dispute to be arbitrated on a class-action basis or to utilize class action procedures; and (c) there is no right or authority for any Dispute to be brought in a purported representative capacity on behalf of the general public or any other persons.</p>
                  </div>
                </details>

                <details className="faq-item">
                  <summary className="faq-q">15. CORRECTIONS</summary>
                  <div className="faq-a">
                ...
                <details className="faq-item">
                  <summary className="faq-q">16. DISCLAIMER</summary>
                  <div className="faq-a">
                ...
                <details className="faq-item">
                  <summary className="faq-q">17. LIMITATIONS OF LIABILITY</summary>
                  <div className="faq-a">
                ...
                <details className="faq-item">
                  <summary className="faq-q">18. INDEMNIFICATION</summary>
                  <div className="faq-a">
                ...
                <details className="faq-item">
                  <summary className="faq-q">19. USER DATA</summary>
                  <div className="faq-a">
                ...
                <details className="faq-item">
                  <summary className="faq-q">20. ELECTRONIC COMMUNICATIONS, TRANSACTIONS, AND SIGNATURES</summary>
                  <div className="faq-a">
                ...
                <details className="faq-item">
                  <summary className="faq-q">21. MISCELLANEOUS</summary>
                  <div className="faq-a">
                ...
                <details className="faq-item">
                  <summary className="faq-q">22. REFUNDS</summary>
                  <div className="faq-a">
                    <p>Our refund policy lasts 30 days from the date of your last payment. If 30 days have gone by since your most recent payment, unfortunately, we cannot offer you a refund or credit.</p>

                    <p>Eligibility for a refund also depends on the number of requests made using our services. If you have sent more than 50 total requests across any of our products—including Generators (generations), AI in Spreadsheets (automations), and Data Analyzer (questions asked)—during this period, you will not be eligible for a refund. This policy is in place because extensive usage incurs significant costs which impact the sustainability of our offerings.</p>

                    <p>To request a refund, please contact our support team at <a href="mailto:hello@formulabyte.com">hello@formulabyte.com</a>. Our team will review your request and inform you of the approval or rejection of your refund based on the conditions mentioned above.</p>
                  </div>
                </details>
              </div>
            </div>
      ...
      <div className="final-cta-wrap">
        <section className="final-cta">
          <div className="final-cta-inner">
            <h2>
              {"Questions about our "}
              <span className="accent">terms?</span>
            </h2>
            ...
            <div className="btn-row">
              ...
              <a href="/privacy-policy" className="btn btn-outline btn-lg">{"View Privacy Policy"}</a>
            </div>
          </div>
        </section>
      </div>
